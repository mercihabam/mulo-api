...
menuRouter.post("/create-menu", checkRequiredFields, checkToken, checkIsCompanyAdmin, checkMenuNameExist, createMenu);
menuRouter.get("/delete-menu/:id", checkToken, checkIsCompanyAdmin, deleteMenu);
menuRouter.post("/update-menu/:id", checkToken, checkIsCompanyAdmin, updateMenu);
