...
const { createOrder, getOrders, getOrder, markAsDelivered, getDeliveredOrders, deleteOrder, getOrdersByUser, getOrderItemsByOrder, getUnDeliveredOrders, getRecentOrders, getOrdersByCompany } = require("../controllers/order.controller");
...
orderRouter.get("/delivered-orders-by-company/:id", checkToken, checkIsCompanyAdmin, getDeliveredOrders);
